...
export default function Banner() {
  ...
  return (
    <section className="w-full h-fit min-h-[400px] xl:min-h-screen flex flex-col xl:flex-row px-5 md:px-10 xl:pt-14 xl:pb-5" /* style={{ minHeight: window.innerWidth >= 1280 ? `calc(100vh - 50px)` : 'auto' }} */
      >
        <div className="w-full h-full text-black flex flex-col xl:flex-row justify-evenly items-center" >
            ...
            <div className="w-full h-1/2 xl:w-fit xl:h-full xl:pt-10 flex flex-col items-center justify-end overflow-hidden">
                  <div className="profile-picture w-[290px] h-[365px]  lg:w-[405px] lg:h-[490px]" role="img" aria-label="Imagem Professora Patrícia Cruz">
