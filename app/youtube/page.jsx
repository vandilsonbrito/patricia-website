...
export default function Youtube() {
  ...
  return (
    ...
    <main className="w-full bg-secundary py-10 lg:py-20 px-5 lg:px-28 flex flex-col justify-center items-center gap-8 lg:gap-5" style={{ minHeight: 'calc(100vh - 100px)' }}>
